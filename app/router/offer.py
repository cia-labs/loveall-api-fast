...
class OfferTypeRouter:
    ...
    def __init__(self):
        ...
        self.router.add_api_route(path='/{offer_type_id:path}', methods=['GET'],dependencies=[Depends(get_current_user)],
        ...
        self.router.add_api_route(path='/update/{offer_type_id:path}', methods=['PATCH'],dependencies=[Depends(get_current_user)],
...
class OfferRouter:
    ...
    def __init__(self):
        ...
        self.router.add_api_route(path='/{offer_id:path}', methods=['GET'],dependencies=[Depends(get_current_user)],
        ...
        self.router.add_api_route(path='/update/{offer_id:path}', methods=['PATCH'],dependencies=[Depends(get_current_user)],
