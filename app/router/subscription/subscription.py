...
class SubscriptionTypeRouter:
    ...
    def __init__(self):
        ...
        self.router.add_api_route(path='/update/{subscription_type_id:path}', methods=['PATCH'],dependencies=[Depends(JWTBearer()),Depends(get_current_user)],
...
class SubscriptionRouter:
    ...
    def __init__(self):
        ...
        self.router.add_api_route(path='/update/{subscription_id:path}', methods=['PATCH'],dependencies=[Depends(JWTBearer()),Depends(get_current_user)],
