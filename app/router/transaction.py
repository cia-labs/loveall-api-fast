...
class TransactionRouter:
    ...
    def __init__(self):
        ...
        self.router.add_api_route(path='/{transaction_id:path}', methods=['GET'],dependencies=[Depends(get_current_user)],
        ...
        self.router.add_api_route(path='/update/{transaction_id:path}', methods=['PATCH'],dependencies=[Depends(get_current_user)],
